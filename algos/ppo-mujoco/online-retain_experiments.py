...
if __name__ == "__main__":
    ...
    run_unlearning(env_id="Walker2d-v3", param_grid={
            ...
            "retain_dim": [400],
            "retain_rand": [0.05],
            "temperature": [2]} ,output_path="./walker2d-final-seed-random_experiments.json", repetitions=10)
    """
    run_unlearning(env_id="Hopper-v3", param_grid={
            ...
            "retain_rand": [0.1],
            "temperature": [2]
        },output_path="./hopper-final-seed_experiments.json", repetitions=10)
    run_unlearning(env_id="HalfCheetah-v3", param_grid={
            ...
            "retain_rand": [0.1],
            "temperature": [2]}
        ,output_path="./halfcheetah-final-seed_experiments.json", repetitions=10)
    """