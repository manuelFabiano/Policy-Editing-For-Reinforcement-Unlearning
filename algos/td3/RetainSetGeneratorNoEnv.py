...
class RetainSetGeneratorNoEnv:
    """
    Generate retain sets for continuous control unlearning without requiring an environment.
    ...
    def distance_aware_sampling(
        ...
        if self.forget_states is None:
            raise ValueError("forget_states must be settati prima del sampling")
