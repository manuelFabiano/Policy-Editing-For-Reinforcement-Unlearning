...
def get_actions_for_states(agent, states, batch_size=32, device=None):
    ...
    with torch.no_grad():
        for i in range(0, len(states), batch_size):
            ...
            probs = agent.policy.get_distribution(batch_tensor).distribution.probs
            batch_actions = torch.argmax(probs, dim=1)
...
if __name__ == "__main__":  
    ...
    run_unlearning_grid_search(env_id="PongNoFrameskip-v4", param_grid={
                ...
                "temperature": [1],
                "scale_factor": [1],
                "learning_rate": [0.0005]},output_path="./pong_est_results.json",repetitions=10)
    ...
    run_unlearning_grid_search(env_id="SpaceInvadersNoFrameskip-v4", param_grid={
                ...
                "steps": [2000]},output_path="./spaceinvaders_results.json", repetitions=10)
    ...
    run_unlearning_grid_search(env_id="EnduroNoFrameskip-v4", param_grid={
                ...
                "scale_factor": [10],
                "learning_rate": [0.0005],
                "steps": [10_000]} ,output_path="./enduro_results.json", repetitions=10)
    ...
    run_unlearning_grid_search(env_id="BreakoutNoFrameskip-v4", param_grid={
                ...
                "scale_factor": [10],
                "learning_rate": [0.0005],
                "steps": [1_000]} ,output_path="./breakout_results.json", repetitions=10)
  """