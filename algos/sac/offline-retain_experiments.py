...
if __name__ == "__main__":
    run_unlearning(env_id="HalfCheetah-v3", param_grid={
            ...
            "retain_dim": [150],
            "retain_rand": [0.1],
            "temperature": [2.5]},output_path="./halfcheetah-est_results.json", repetitions=10)
    run_unlearning(env_id="Hopper-v3", param_grid={
            ...
            "retain_dim": [300],
            "retain_rand": [0.05],
            "temperature": [5]}, output_path="./hopper-est_results.json", repetitions=10)
    run_unlearning(env_id="Walker2d-v3", param_grid={
            ...
            "retain_dim": [150],
            "retain_rand": [0.1],
            "temperature": [2.5]}, output_path="./walker2d-est_results.json", repetitions=10)